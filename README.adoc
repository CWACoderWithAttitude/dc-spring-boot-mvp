...
To run the collections from the command line, you first need to install the Bruno CLI. Since `npm` is included in this devcontainer, you can install it with:
...
- https://www.freecodecamp.org/news/how-to-run-github-actions-locally/s[Test Github Actions locally] with `act`
...
- https://docs.postgrest.org/en/v12/explanations/install.html[PostgREST Installation]
- 
[ditaa]
...